...
const FormularioDinamico = ({ order, onClose }) => {
  ...
  const formatFieldName = (fieldName) => {
    ...
    const fieldNameMappings = {
      ...
      'revision_agente': 'REVISION DEL ESTADO Y CANTIDAD DEL AGENTE',
      'estado_cilindro_agente': 'REVISION DEL ESTADO Y CANTIDAD DEL AGENTE',
      'estado_disco_ruptura': 'ESTADO DEL DISCO DE RUPTURA',
      'cantidad_estado_boquillas': 'CANTIDAD Y ESTADO DE BOQUILLAS',
      'tipo_tapones_boquillas': 'TIPOS DE TAPONES DE BOQUILLAS / METALICAS O GOMA',
